    ...
    public partial struct FirstPersonPlayerInputsSystem : ISystem
    {
        ...
        public void OnUpdate(ref SystemState state)
        {
                         ...
                         .WithAll<GhostOwnerIsLocal, FirstPersonPlayer>())
            {
                ...
                playerCommands.ValueRW.SprintHeld = false;

                playerCommands.ValueRW.SprintHeld = defaultActionsMap.Dash.IsPressed();
                ...
                playerCommands.ValueRW.JumpHoldTime = 0f;
                playerCommands.ValueRW.SlowFall = false;

                playerCommands.ValueRW.DashPressed = default;
                if (defaultActionsMap.Dash.WasPressedThisFrame())
                    playerCommands.ValueRW.DashPressed.Set();
